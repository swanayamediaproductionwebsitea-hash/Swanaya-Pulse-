...
export default function RdAccessBadge({ level, onClick, className = '' }: RdAccessBadgeProps) {
  ...
  let tierLabel = 'RESEARCH TIER 2 • PRO';
  ...
  if (normalized.includes('community')) {
    ...
    tierLabel = 'ENTERPRISE AI • 2026 EDITION';
  ...
  return (
    <motion.button
      ...
      title={`Research & Innovation Level: ${level}. Click to manage AI Research Lab access & compute credits.`}
    >
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Research & Innovation:</span>
